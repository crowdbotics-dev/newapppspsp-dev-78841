"""
Django settings for newapppspsp_dev_78841 project.
...
ROOT_URLCONF = 'newapppspsp_dev_78841.urls'
...
WSGI_APPLICATION = 'newapppspsp_dev_78841.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "newapppspsp_dev_78841 API",
    "DESCRIPTION": "API documentation for newapppspsp_dev_78841 App",
    "VERSION": "v1",
}
